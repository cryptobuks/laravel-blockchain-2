                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.update', ['id' => $employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('middlename') ? ' has-error' : '' }}">
                            <label for="middlename" class="col-md-4 control-label">Email</label>

                            <div class="col-md-6">
                                <input id="middlename" type="email" class="form-control" name="middlename" value="{{ $employee->middlename }}" required>
                        ...
                        <div class="form-group">
                            <label for="avatar" class="col-md-4 control-label" >Wallet</label>
                            <div class="col-md-6">
                                <input type="file" id="picture" name="picture" />
                            </div>
                        </div>
